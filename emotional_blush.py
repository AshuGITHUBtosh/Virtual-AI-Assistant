    ...
    await vts.request(models.InjectParameterDataRequest(
        data=models.InjectParameterDataRequestData(
            parameter_values=[
                ...
                models.ParameterValue(id="EyeOpenLeft", value=0.0),
                models.ParameterValue(id="EyeOpenRight", value=0.0),
                models.ParameterValue(id="FaceAngleY", value=-30.0)
...
def speak_blush(text: str):
    run_tts_and_mouth(text)

if __name__ == "__main__":
    sample_text = "master please, don't teas me."
    speak_blush(sample_text)
